<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Personality_Prediction.User_Home_Page.Registration" %>
...
<body>
   ...
   <img src="../Images/loginimg.png" class="mx-auto d-block"  />
    ...
    <label id="a1"><b>Admin Name</b></label><br />
    <asp:TextBox runat="server" ID="name" placeholder="Adminname" CssClass="form-control " class="auto-style1"  Width="308px" style="margin-top:10px;"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" ID="fname" ControlToValidate="name" Text="*" ErrorMessage="Please Enter Your Name" ForeColor="Red"></asp:RequiredFieldValidator>
      </div>
        <div class="form-group">
       ...
       <asp:Button runat="server" ID="Save" Text="Submit" OnClick="Save_Click" CssClass="btn btn-secondary" style=" margin-left:38px; margin-bottom:20px; margin-top:10px;"/>
        <%--<a href="Admin Login.aspx">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Already have account! Login here</a>--%>
