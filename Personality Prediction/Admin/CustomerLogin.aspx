<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLogin.aspx.cs" Inherits="Personality_Prediction.Admin.CustomerLogin" %>
...
<body>
    ...
    <div class="row h-100 justify-content-center align-items-center">
       ...
       <img src="../Images/loginimg.png" class="mx-auto d-block"  />
        ...
        <br /></div>
         <asp:Button runat="server" ID="GetData" Text="Login" CssClass="btn btn-secondary" OnClick="GetData_Click" style=" margin-left:38px;margin-bottom:20px; margin-top:10px;"  />
      <a href="http://localhost:64014/Admin/CustomerRegistration.aspx">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;If you don't have account! Register here</a>
